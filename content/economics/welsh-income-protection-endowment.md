---
title: "A Welsh Income Protection Endowment"
subtitle: "The institutional architecture for a permanent, self-financing Welsh institution to end the Universal Credit cliff-edge"
...
**Constitutional status.** The compatibility of this proposal with the present Welsh devolution settlement has not been established. Social security schemes supported from public funds are reserved to Westminster under the Government of Wales Act 2006, so whether a contributory endowment of this kind can be structured within Wales's existing competence, or would instead require UK legislation or intergovernmental agreement, is an open question that an independent competence opinion must resolve. Competence is moreover only the first of two gateways: even a favourable legal opinion would leave the political agreement, potentially including cooperation from the UK Government, that establishing the institution would require. This paper treats those constitutional and political gateways as the first questions, ahead of the actuarial ones, and does not assert that the scheme is within current competence or that Wales can enact it today.

## 1. Executive summary

This paper develops the institutional architecture for a **Welsh Income Protection Endowment**. Whether Wales presently possesses the constitutional authority to establish such an institution is unresolved and requires an independent legal opinion; and even a favourable opinion would leave a second gateway, the political agreement the design would need, potentially including cooperation from the UK Government. The analysis that follows therefore examines how such an institution would operate if those constitutional and political conditions were met, rather than asserting that Wales can implement it under the settlement as it stands today.

Read in that spirit, the proposal is a permanent capital fund that pays a time-limited income top-up to Welsh workers who lose their job or their hours, so that an ordinary setback does not mean an immediate fall to Universal Credit.
...
The design is shaped by the single structural fact that constrains Welsh policy: Wales controls its own income tax rate, its primary legislation and its public bodies, but not National Insurance, large-scale borrowing, or the wider tax base. The design leans on the one major fiscal lever Wales controls, its income tax rate, rather than on the reserved powers. But it raises a prior constitutional question that this paper does not gloss: social security supported from public funds is itself reserved, so whether a statutory scheme of this kind can be created within Wales's existing competence is unresolved and is taken up in section 10. That makes this as much a proposal about **institution building**, and about the limits of what Wales can build, as about social security.
...
The following describes the scheme as it would operate once established, on the assumption that the constitutional and political gateways set out above have been passed. A statutory Welsh Income Protection Fund is built by a hypothecated penny of the Welsh basic rate of income tax, collected temporarily. During the build phase the fund pays a capped, tapering, time-limited top-up above Universal Credit to workers who lose hours or their job after a qualifying contribution period, and retains everything else to grow. Once the corpus is large enough that investment income covers claims and keeps the fund growing, the levy ends. Thereafter the fund runs in perpetuity on its returns, under a rule that holds payouts below income over the fund's normal path, so the corpus grows through ordinary years, with the reserve and, in exceptional downturns, capital itself absorbing the years when claims spike. Beyond meeting claims, the fund returns a share of its surplus, at the end of each member's working life, to those who contributed throughout but claimed least, capped so no individual reward can ever reach a destabilising size. Entitlement is earned by contribution and involuntary loss of work, not by holding a Universal Credit claim.

---

## 4. How it works: the design pillars

The pillars below describe how the institution would be designed to work if it could be established. They are set out in the present tense for clarity; the conditional character of the whole scheme is the constitutional and political question held open throughout.

**A temporary levy, not a permanent tax.** The penny is collected only during the build phase. Once the fund reaches the level at which its income covers claims and still grows the corpus, the levy stops automatically under the scheme's own rules, and is not intended to return unless a future generation chooses to expand the institution. No Act can bind a future Senedd, so the permanence of cessation is a matter of political durability rather than an enforceable guarantee; what the design fixes is that stopping is the automatic default, not a discretionary choice. This is the feature that makes the ask politically different from an ordinary tax rise: workers are asked to build something, not to fund it forever.
...
**Payouts always below income, so the fund always grows.** Once mature, the fund follows a simple rule: total payments out, claims plus reward, are held below the fund's income in normal years, so the corpus grows over its long-run path. In a severe downturn the discretionary reward falls to zero and, if necessary, capital is drawn, with the corpus recovering as conditions normalise; the rule describes the intended path, not a guarantee for every individual year. Because claims are indexed to earnings and therefore rise at roughly 1.2% a year in real terms, the fund must retain more than that to genuinely pull ahead of its liabilities; a token retention is overtaken by rising claims. Retaining above the claim-growth rate produces the compounding, accelerating growth the institution depends on, and is comfortably achievable once the fund is large.
...
Recurrent transfer spending is consumed. One billion pounds paid out as ordinary benefits or transfers buys a year of support and is then gone. Capital spending on infrastructure, education or prevention can of course leave lasting value; the relevant comparison here is with recurrent transfer payments, which is what an income-protection scheme would otherwise be. One billion placed into this fund is not consumed; it is converted from cash into an invested public asset that continues to exist and to earn indefinitely, and that at a conservative real return works permanently against a liability the government would otherwise finance from annual taxation. The Welsh public balance sheet is stronger decades later, not weaker, because the state holds a growing, income-generating asset rather than the memory of a spent sum. It is the difference between paying rent and buying the building, or, in the sovereign-fund analogy, between spending a windfall and converting it into a permanent financial asset as Norway did with oil.
...
A protected capital fund lives or dies by its governance, because the proposition depends on the corpus surviving decades of political and economic pressure. The governance set out here is the design the institution would require if established; described in the present tense for clarity, it remains conditional on the authority discussed in section 10. The design borrows from central banking: the hardest decisions are governed by pre-legislated automatic rules rather than ministerial discretion.

**Legal form and ownership.** The fund would be established as a statutory corporation at arm's length from Welsh Ministers, holding the corpus on behalf of Welsh contributors. Its precise legal form, including whether contributors hold any beneficial interest or the corpus is public money under statutory protection, is a question for the legal structuring work, since paying a tax does not by itself create a trust or a beneficial entitlement.

**Protection from raiding.** The corpus is ring-fenced in statute, drawable only against defined, published triggers, and never for general spending. Diversion would require primary legislation and an affirmative Senedd vote, making a raid a visible, debated act rather than a quiet transfer. Because the fund is held under statutory protection for contributors, governed by independent trustees with a duty to resist diversion, and reported annually to the Senedd, a raid is intended to be not a budget adjustment but a visible confiscation of protected entitlements, which is what would deter it. Whether contributors hold a beneficial interest in law, or the protection rests on statute alone, is part of the legal structuring the scheme would require. No statute is absolutely raid-proof against a determined majority; the defences make a raid slow, visible, and politically costly rather than impossible.
...
The contribution itself uses a lever Wales clearly controls: the Welsh Rates of Income Tax, devolved since 2019. The harder question is the scheme the revenue would fund. Social security supported from public funds is reserved to Westminster under the Government of Wales Act 2006, and a statutory scheme paying income-related assistance on involuntary loss of work sits close to that reservation; the reserved-powers test turns on the purpose and effect of a scheme, not the label placed on it, so describing it as an endowment or as contributory insurance does not by itself take it outside social security. Whether the capitalised, contributory design proposed here falls within Wales's competence, could be restructured to do so, or would require UK legislation or intergovernmental agreement, cannot be asserted either way in this paper and is a matter for constitutional counsel. The Wales Pension Partnership offers a partial precedent for the financial machinery but not the legal form: it demonstrates that Welsh public pension funds can pool and invest assets at scale through a host authority and an external regulated operator, though it is a collaboration of the eight Welsh local-government pension funds rather than a Senedd-created statutory institution, and is not a direct precedent for the body proposed here. What is proposed is, in substance, a permanent Welsh public endowment institution, of which income protection is the first application; whether Wales can create it under present powers is precisely the constitutional question the feasibility work must answer first.
...
## 12. Implementation, subject to the constitutional and political gateways

Implementation is not the immediate next stage. Before any implementation question arises, the proposal requires independent constitutional advice, actuarial feasibility work, and, depending on that advice, any necessary agreement with the UK Government or further devolution of powers. This section therefore describes how the institution would be implemented if those prior gateways were passed; it is not a claim that Wales can proceed to implementation now.

Three feasibility questions then order the work. The first is legal, and it is unresolved: because social security supported from public funds is reserved, whether this scheme can be established within Wales's competence must be settled by constitutional counsel before anything else proceeds, and even a favourable opinion may leave a political gateway, the UK-Government agreement or further devolution the design might require. The second is financial, and on the terms of the model the scheme would be self-funding after a temporary levy. The third is administrative: the scheme is designed to lean on existing machinery rather than a new bureaucracy, using HMRC for the contribution record and the Department for Work and Pensions for the income-loss determination, but because HMRC and DWP are reserved bodies whose functions a Senedd Act cannot unilaterally extend, this is a proposed delivery route that would require their agreement rather than something the Senedd can enact alone. Subject to those gateways being passed, the sequence would be:
...
The endpoint is not an immediate request for legislation. It is a request to test the idea rigorously, and in the right order. The pathway is staged: publish this paper; obtain an independent competence opinion on whether a scheme of this kind can be created within Wales's powers, or what would have to change for it to be, since that question sits ahead of all the others; commission an independent actuarial feasibility study; build the model on official HMRC, DWP and Welsh Government data, replacing this paper's assumed claim rate and return with real distributions; secure any political agreement that the competence opinion shows to be necessary, whether cooperation from the UK Government or further devolution of powers, since a favourable legal opinion alone would not make implementation possible; and only then, if the legal, actuarial and political gateways are all passed, draft legislation and consult on the final parameters, above all the target size and the length of the levy.

The Welsh Government is not being asked to accept one person's model. It is being asked to test, using data it alone can access, whether a scheme this promising is viable. If it is, the debate shifts from whether the idea is serious to how big to build the fund and how long to levy the penny. The prize, if the necessary constitutional and political authority can be secured, is a permanent, self-funding Welsh institution that ends the Universal Credit cliff-edge for working people, rebuilds something of the contributory principle Wales was denied when National Insurance stayed reserved, rewards a lifetime of self-reliance, and leaves the Welsh balance sheet holding a lasting and growing national asset, all for a levy that one day ends.
...
| --- | --- | --- |
| Covered workers | 1,500,000 | Data (APS / HMRC) |
...
| Real investment return | 3.5% to 5.5% (plan on 3.5–4%) | Key assumption (range) |
| Qualifying-claim rate | 3% to 5% (central 4%) | Key assumption (range) |
| Average claim cost | £2,200, earnings-indexed | Assumption |
| Earnings growth (claim indexation) | 1.2% real / year | Assumption |
| Initial capital seed | £1bn to £5bn (policy variable) | Policy choice |
| Milestone: income covers claims | ~£4.2bn | Derived |
| Milestone: levy can stop | ~£6.3bn (at 3.5% real) | Derived |
| Build target (sets reward) | ~£12bn (modest) to ~£20bn (max reward) | Policy choice |
| Individual reward ceiling | 75–80% of average earnings, indexed | Design rule |
...
<details class="annex" id="annex-b">
<summary>Appendix B — Modelling methodology</summary>
...
<summary>Appendix C — Operational implementation considerations</summary>
...
**Who collects the contribution.** The intended route is HMRC, using existing machinery, but it would require HMRC agreement rather than a unilateral Senedd assignment, since HMRC is a reserved body. The penny is a variation of the Welsh Rates of Income Tax, which HMRC already administers and collects through PAYE and self-assessment, so no new collection system would be required, though hypothecating the proceeds into a ring-fenced fund is a different matter from HMRC collecting an ordinary rate. The Welsh Revenue Authority collects only the fully devolved taxes (land transaction tax and landfill disposals tax) and is not involved in the income tax penny. The hypothecation happens on the Welsh side: the statute directs that a sum equivalent to the penny is paid from the Welsh Consolidated Fund into the ring-fenced fund. The separate below-threshold voluntary contribution for gig workers, modelled on Class 2 National Insurance, sits outside income tax and would need a small dedicated collection channel, run by the fund's administrator or the WRA.

**How the first claims are administered, before maturity.** Claims are administered from day one, met in the early years from contributions, seed income and modest capital drawdown until investment income takes over. The intended delivery model would lean on existing infrastructure on three legs, each of which depends on agreement with a reserved body rather than on Senedd enactment alone: HMRC would provide the contribution record, so the cumulative-year qualifying test could be verified from data it already holds; the Department for Work and Pensions would determine the qualifying income-loss event and apply conditionality, with the fund riding on DWP's existing Universal Credit assessment rather than duplicating it (a data-sharing and delivery agreement with DWP is the single most important operational relationship to secure, and cannot be assumed); and the fund would calculate and pay the top-up alongside the UC award and manage the corpus. The aim is that the principal build is the fund and its investment operation, not a new benefits-administration bureaucracy, but this rests on intergovernmental agreement that the feasibility work must test.

</details>

<details class="annex" id="annex-d">
<summary>Appendix D — Questions the feasibility study should answer</summary>
...
1. **Devolved competence (the prior question).** Can a contributory, capitalised income-protection scheme of this kind be established within Wales's existing competence, given that social security supported from public funds is reserved under the Government of Wales Act 2006, or would it require restructuring, UK legislation, or intergovernmental agreement? This is a legal question for constitutional counsel rather than an actuarial one, and it sits ahead of every question below: if it is not resolved favourably, the rest does not arise. It also governs the delivery assumptions, since HMRC and DWP are reserved bodies whose involvement would require agreement.
2. **The qualifying-claim rate.** What is the actual annual rate at which Welsh workers would make a valid claim, derived from HMRC, DWP and Welsh redundancy and claimant-flow data, rather than the reasoned 4% assumption used here? This is the single parameter on which the whole model turns.
3. **Claim duration and size.** What is the real distribution of claim durations and top-up amounts, as against the single average claim this model uses, and how does that distribution behave in downturns?
4. **Contribution level.** Does a single penny provide the right balance of adequacy and sustainability, or would a different contribution, or a variable one, better meet a stated objective?
5. **Investment strategy.** What long-horizon investment strategy and real-return assumption are appropriate for a fund of this kind, and how does a more conservative or more volatile return profile affect the timeline and the buffer?
6. **Governance and political risk.** What governance model, and what statutory protections for the corpus, most credibly minimise the risk of the fund being raided or dismantled by a future government?
7. **Seed and maturity objective.** What capital seed corresponds to each plausible maturity objective, and what is the right objective for Wales to adopt, given the trade-off between upfront cost, speed to self-financing, and fairness to the first cohort?
8. **Recession behaviour and stochastic solvency.** The stress tests in this paper are deterministic and illustrative. A study should replace them with stochastic modelling that establishes a confidence level for solvency, and that tests the factors a deterministic model cannot: the sequence of investment returns, the correlation between rising unemployment and falling markets, and prolonged shocks such as unemployment remaining elevated for a decade rather than five years. It should also calibrate the automatic payout taper and buffer thresholds against genuine historical recession data rather than the stylised scenarios used here.
9. **Member rewards.** How should the end-of-working-life reward be structured and weighted by claims history, and what distributional and behavioural effects would different structures produce?
10. **Indexation of the top-up.** To what should the bridge payment be indexed — Universal Credit rates, median earnings, prices, or a combination — so that it stays a stable proportion of a living income over time without either eroding or drifting?
11. **Build target, the solvency floor, and levy duration.** How large should the fund be built before the levy stops, given the trade-off between the length of the levy, the size of the seed, and the perpetual reward the target size supports? A prior constraint applies: the level at which the levy can permanently stop is set by the need to keep growing through adverse sequences, not by the average-case break-even of about £6.3bn, so the study should establish that solvency floor and the reserve implied by the gap between it and the break-even. The reward-maximising target and the prudent solvency minimum may turn out to be close, which the study should determine. This is the central policy choice the study should frame for ministers.
12. **Early reward versus build speed.** How large a reward should the fund pay during the build phase? Income bridges are paid from the first year regardless, but every pound of early reward is a pound not retained, lengthening the levy. The study should quantify this trade-off so the balance between visible early generosity and speed to self-funding can be chosen deliberately.
13. **Calibration of the reward cap and reserve.** What starting level, rate of decline, and floor for the reward-distribution cap, and what solvency-reserve target above the buffer, best keep the fund growing under sustained pressure while still paying a meaningful reward, and over what smoothing period should the cap be calculated?
14. **Contributors outside Universal Credit.** What share of qualifying contributors would fall outside UC, whether through the savings or partner-earnings rules or by choice, and how does that affect the claim rate? Because the fund pays only its own top-up portion in every case, this is a question about the volume of claims rather than their size, but it is needed to model take-up accurately.
...
6. Wales Pension Partnership (walespensionpartnership.org) and annual reports, 2024–2025. A collaboration of the eight Welsh Local Government Pension Scheme funds, hosted by Carmarthenshire County Council and using an external regulated operator; cited as practical Welsh experience of pooled public-asset investment, not as a legal precedent for the statutory body proposed here.
