...
**Provenance is not cultural direction.** Where an element came from and what it contributes to the society on the page are separate questions. Answering the first does not answer the second.

**Failed positive evidence is not counterevidence.** A comparison that fails to establish X does not establish not-X. Both moves need knowledge the text withholds.

**Compatibility is not corroboration.** Material that would fit an unattested claim raises no probability, because it would fit equally well whether the claim were true or false.
