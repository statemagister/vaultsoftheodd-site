---
title: "Sufficient to Play"
slug: "sufficient-to-play"
date: 2026-09-09
settings: ["Greyhawk"]
...
*Evidence: I1, both 1981 printings, and the books it names: the Fiend Folio, the Dungeon Masters Guide. Nothing published later is used.*

---

## A room with a worm in it

Area C8 is on the main tunnel route, the way the city's own inhabitants come and go. A chamber, a pool of unknown depth, a row of moss-covered boulders reaching halfway across towards the exit. The water ripples as though something flows through it.

The boulders are the back of a giant bloodworm. Here is what the module tells the referee about it, complete:

> AC 4; MV 6"; HD 6; hp 40; #AT 1; D 1-8; successful hit attaches to victim, automatically draining 1-8 points of blood per round, saves vs. Magical Fire at -2, takes double damage from fire.

It waits until the party is on the middle of its back, or halfway across, before attacking.

Then the room. The pool is four feet deep. A film of oil has leeched from the rocks and coats anyone wading through it. The oil does not burn easily and will ignite only near a great source of heat, a fireball or similar. It burns for one round, does 1d6, and then fills the chamber with smoke doing 1d4 a round to everyone in it thereafter.

Run that as written. The worm attaches to a character and begins draining automatically, no attack roll, every round. The party can kill a six-hit-dice creature with forty hit points while their companion loses 1-8 a round, or find another way to make it release them.

The oil is right there. Most referees will read it as a hazard.

## The sentence that is missing

The Fiend Folio's entry for the giant bloodworm says something I1 does not.

It says that the creature is particularly vulnerable to fire, taking double damage and saving at a penalty against magical fire, both of which I1 reproduces. And then it says that a successful fire attack is the only way, short of killing the beast, to force it to relax its grip on a victim.

I1 keeps the numbers and drops the function.

Go back to the room with that sentence in hand and it reorganises. The oil is no longer merely a hazard near the monster. Under the Fiend Folio rule, it is also the means of forcing the monster to release its victim, supplied in the same chamber and carrying a cost of its own. A party that burns the pool frees their companion and chokes themselves. A party that does not has no way to free him at all.

That is a well-made encounter. It is also one a referee cannot see from the module, because the line that makes the oil legible is in a different book.

## What the module says about that

I1 addresses this directly, and its own wording gives us a test.

Five of its creatures come from the Fiend Folio: the giant bloodworm, the bullywug, the pan lung, the yellow musk creeper and the yellow musk zombie. Of these the module says that descriptions sufficient to play them appear in the text.
...
## The same test, from the other direction

The yellow musk creeper sits at C4, also on the main route, and is the module's purest save-or-lose encounter. Three zombies attack the party from behind, driving them towards a cave mouth, and anything within ten feet of the cave is in the plant's reach. The module says outright that it is impossible to enter without being attacked.

The mechanics are inherited almost exactly: the dust, the save, the entrancement, tendrils attaching with no attack roll, intelligence drained at 1-4 a round, death at zero, zombification at one or two. All faithfully reproduced.

Two things are not.

The Fiend Folio says the creeper's only vulnerable point, its bulbous root, is buried a foot below the surface, and that the belongings of previous victims lie near it because the plant scrapes soil over the evidence. I1 says only that the way to kill it is to stab at the bulbous root. A referee working from the module knows what the weak point is, but not where it is.
