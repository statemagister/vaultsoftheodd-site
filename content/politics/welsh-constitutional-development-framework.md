...
This is the foundational paper of the set, and the place to start. Its thesis — that constitutional durability follows institutional capability — is the premise the companions develop. [Post-Election Commentary](/politics/post-election-commentary/) reads the 8 May 2026 Senedd result against it; [Wales–Westminster Constitutional Development](/politics/wales-westminster-constitutional-development/) examines the Westminster side of the same settlement; [Constructing Coordinating Machinery](/politics/constructing-coordinating-machinery/) offers a concrete worked example of the institutional capability argued for here; [Comparative Fiscal Capacity](/politics/comparative-fiscal-capacity/) carries the competence-versus-capability distinction into the fiscal domain, asking what each of the three live constitutional paths would actually require Wales to build; and [Representing Contested Constitutional Questions Accurately](/politics/representing-contested-constitutional-questions/) sets out the descriptive method the whole approach relies on.
