---
title: "A Framework for Welsh Constitutional Development"
subtitle: "Strategic Priorities for the 2026–2030 Senedd Term"
slug: "welsh-constitutional-development-framework"
...
pdf: "/papers/griffiths-welsh-constitutional-framework-june-2026.pdf"
...
This is the foundational paper of the Welsh Framework Series, and the place to start. Its thesis — that constitutional durability follows institutional capability — is the premise the companion papers develop. [Wales–Westminster Constitutional Development](/politics/wales-westminster-constitutional-development/) examines the Westminster side of the same settlement; [Constructing Coordinating Machinery](/politics/constructing-coordinating-machinery/) offers a concrete worked example of the institutional capability argued for here; [Comparative Fiscal Capacity](/politics/comparative-fiscal-capacity/) carries the competence-versus-capability distinction into the fiscal domain, asking what each of the three live constitutional paths would actually require Wales to build; and [Post-Election Commentary](/politics/post-election-commentary/) closes the series by applying the completed architecture to a real political moment, reading the 8 May 2026 Senedd result against it. The descriptive method the whole approach relies on is set out separately in [Representing Contested Constitutional Questions Accurately](/politics/representing-contested-constitutional-questions/), a supporting paper.

The framework's central reference point, the [Independent Commission on the Constitutional Future of Wales (2024) final report](https://www.gov.wales/independent-commission-on-the-constitutional-future-of-wales-final-report), is on gov.wales; the full list of works cited is in the References above.
