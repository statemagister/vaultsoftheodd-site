...
weight: 55
series: "standalone"
summary: "A proposal for a permanent, largely self-financing Welsh capital institution that protects workers' incomes after redundancy or lost hours, funded by a temporary hypothecated penny on the Welsh basic rate of income tax. Once the fund's own investment returns cover claims and keep the corpus growing, the levy stops and the institution runs in perpetuity on its returns. Whether a contributory scheme of this kind can be created within Wales's devolved competence — social security being reserved to Westminster — is itself unresolved, and the paper treats that as the first feasibility gate. Offered as analysis and a case for an independent competence opinion and actuarial feasibility study, not a finished plan."
...
Before the operational machinery, three feasibility questions matter most, and they must be taken in order. The first is legal, and it is unresolved: because social security supported from public funds is reserved, whether this scheme can be established within Wales's competence must be settled by constitutional counsel before anything else proceeds. The second is financial, and on the terms of the model the scheme is self-funding after a temporary levy. The third is administrative: the scheme is designed to lean on existing machinery rather than a new bureaucracy, using HMRC for the contribution record and the Department for Work and Pensions for the income-loss determination, but because HMRC and DWP are reserved bodies whose functions a Senedd Act cannot unilaterally extend, this is a proposed delivery route that would require their agreement rather than something the Senedd can enact alone. On that basis, and subject to the competence question being resolved first, the sequence is:
